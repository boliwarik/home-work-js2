...
/* function ageClassification(n) {
  if (n<0){
    ...
    return (str = 'детский возраст');
  else if (n>24, n<=44)
    return (str = 'молодой возраст');
  else if (n>44, n<=65)
    return (str = 'средний возраст');
  else if (n>65, n<=75)
    return (str = 'пожилой возраст');
  else if (n>75, n<=90)
    return (str = 'старческий возраст');
  else if (n>90, n<=122)
    return (str = 'долгожители');
  else if (n>122)
    return (null);
};
*/
